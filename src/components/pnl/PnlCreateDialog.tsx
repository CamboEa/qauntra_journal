...
type Props = {
  open: boolean;
  onClose: () => void;
  onCreated: (account: PnlAccount) => void;
};

export function PnlCreateDialog({ open, onClose, onCreated }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <h2 className="text-lg font-semibold text-q-text">New PNL account</h2>
        <p className="mt-1 text-sm text-q-text-2">Set a name, starting balance, and goal target.</p>
